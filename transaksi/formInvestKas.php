...
<body>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-9 lebar-xy">
            ...
            <form action="confInvest.php" enctype="multipart/form-data" method="post">
                <div class="mb-3">
                    <label for="id_member" class="form-label">ID Member</label>
                    <input type="number" class="form-control" id="id_member" name="id_member" value="<?php echo $data['id'] ?>" readonly>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="tanggal_pembayaran" class="form-label">Tanggal Investasi</label>
                    <input type="date" class="form-control" id="tanggal_pembayaran" name="tanggal_pembayaran">
                </div>
                <div class="mb-3">
                    <label for="jumlah_masuk" class="form-label">Jumlah Investasi Kas</label>
                    <div class="input-group mb-3">
                        <span class="input-group-text">Rp.</span>
                        <input type="number" class="form-control" aria-label="Masukkan Jumlah" name="jumlah_masuk">
                        <span class="input-group-text">.00</span>
                    </div>
                </div>
                <div class="mb-3">
                    <label for="bukti_bayar" class="form-label">Bukti Transfer</label>
