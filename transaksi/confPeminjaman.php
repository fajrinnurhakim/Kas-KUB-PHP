<?php 
	...
	if(isset($_POST['submit'])){
		...
		// 		$query = "INSERT INTO temp_bayarkas (id_member, nama, tanggal, jumlah_keluar, keterangan, keperluan) VALUE ('$id_member', '$nama', '$tanggal', '$jumlah_keluar', 'Peminjaman Kas', '$keperluan')";
	    ...
	    //buat query
	    $sql = "INSERT INTO temp_transaksi (id_member, nama, tanggal, jumlah_keluar, keterangan, keperluan, setatus) VALUE ('$id_member', '$nama', '$tanggal', '$jumlah_keluar', 'Peminjaman Kas', '$keperluan', 'Menunggu Konfirmasi')";
	    ...
	    if( $query ) {
	        ...
	        echo "
	            <script>
	                alert('DATA PEMINJAMAN DANA BERHASIL DI INPUT');
                    document.location.href = '../kasPinjam.php';
	            </script>
	            ";
	    } else {
	        // kalau gagal alihkan ke halaman indek.php dengan status=gagal
	         echo "
	            <script>
	                alert('DATA PEMINJAMAN DANA GAGAL DI SIMPAN');
