		...
		if($tipe_file == "image/jpeg" || $tipe_file == "image/png"){
			...
			if($ukuran_file <= 1000000){
			  ...
			  if(move_uploaded_file($tmp_file, $path)){
				...
				$query = "INSERT INTO temp_transaksi (id_member, nama, tanggal, jumlah_masuk, keterangan, bukti_bayar, setatus) VALUE ('$id_member', '$nama', '$tanggal', '$jumlah_masuk', 'Investasi', '$nama_file', 'Menunggu Konfirmasi')";
				...
				if($sql){
				  ...
				  echo "
	            	<script>
	                	alert('DATA INVESTASI BERHASIL DI INPUT');
				  ...
				  echo "<br><a href='formInvestKas.php'>Kembali Ke Form</a>";
				}
			  }else{
