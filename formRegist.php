        ...
        <div class="row justify-content-center">
                <div class="col-md-5">
                    ...
                    <main class="form-signin w-100 m-auto">
                        <center>
                            <h3 class="h3 fw-normal" style="margin-top: 30px">Silahkan Input Password Baru Anda</h3>
                            <p><strong>HARAP DI INGAT, PASSWORD TIDAK DAPAT DIRUBAH</strong></p>
                        </center>
                        <form action="confFormRegist.php" method="post">
                            
                            <div class="form-floating">
                                <input type="number" name="id_member" class="form-control" id="id_member" value="<?php echo $data['id'] ?>" readonly>
                            ...
                            <button class="w-100 btn btn-lg btn-primary" type="submit" name="submit" value="submit">DAFTAR</button>
                        </form>
