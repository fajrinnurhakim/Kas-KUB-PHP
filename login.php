            ...
            <div class="row justify-content-center">
                <div class="col-md-5">
                    ...
                    <main class="form-signin w-100 m-auto">
                        <center>
                            <h1 class="h3 fw-normal" style="margin-top: 140px">Silahkan Login</h1>
                        </center>
                        <form action="confLogin.php" method="post">

                            <div class="form-floating">
                                <input type="number" name="id_anggota" class="form-control" id="id_anggota" placeholder="12345..." autofocus required>
                                <label for="id_anggota">ID Keanggotaan</label>
                            </div>
                            <div class="form-floating">
                        ...
                        <small class="d-block text-center mt-3">Anda Sebagai Admin dan Belum Memiliki Akses Login? <a href="register.php">Silahkan Daftar</a></small>
                    </main>
                </div>
            </div>
        </div>
