    ...
    <div class="row justify-content-center">
        <div class="col-lg-9 lebar-xy">
            ...
            <div class="container-new-member">
                ...
                <form action="confEditDataMember.php" method="post" enctype="multipart/form-data">

                    <div class="bagidua">
                        <div class="mb-3">
                            <label for="nama" class="form-label">Nama</label>
                            <input type="text" class="form-control" id="nama" placeholder="Masukkan Nama Member" name="nama" value="<?php echo $data['nama'] ?>">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" placeholder="Masukkan Alamat Member" id="alamat" style="height: 100px" name="alamat"><?php echo $data['alamat'] ?></textarea>
                        </div>
                    </div>
                    <div class="bagidua2">
                        <div class="mb-3 floating">
                            <label for="nama_usaha" class="form-label">Nama Usaha</label>
                            <input type="text" class="form-control" id="nama_usaha" placeholder="Masukkan Nama Usaha Member" name="nama_usaha" value="<?php echo $data['nama_usaha'] ?>">
                        </div>
                        <div class="mb-3">
                            <label for="jenis_usaha" class="form-label">Jenis Usaha</label>
                            <input type="text" class="form-control" id="jenis_usaha" placeholder="Masukkan Jenis Usaha Member" name="jenis_usaha" value="<?php echo $data['jenis_usaha'] ?>">
                        </div>
                        <div class="mb-3">
                            <label for="no_hp" class="form-label">No HP/WA</label>
                            <input type="text" class="form-control" id="no_hp" placeholder="Masukkan Nomor HP/WA " name="no_hp" value="<?php echo $data['no_hp'] ?>">
                        </div>
                        <div class="mb-3">
                            <label for="foto_member" class="form-label">Foto Member</label>
                            <input class="form-control" type="file" id="foto_member" name="foto_member" value="<?php echo "../images/".$data['nama'] ?>">
                        </div>
