...
<body>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-9 lebar-xy">
            ...
            <h3 style="margin-top: 20px;"><center><strong>DAFTAR LIST MEMBER</strong></center></h3>
            <table class="table table-striped" style="margin-top: 20px;">
                ...
                <?php
                $sql = "SELECT * FROM tbl_keanggotaan";
                ...
                while ($data = mysqli_fetch_array($query)) {
                    ...
                    echo "<td>";
                    echo "<a class='btn btn-success' href='admLihatDetailDataMember.php?id=" . $data['id'] . "'>LIHAT DETAIL</a> &nbsp &nbsp";
                    echo "<a class='btn btn-danger' href='admEditDataMember.php?id=" . $data['id'] . "'>EDIT DATA</a>";
                    echo "</td>";
