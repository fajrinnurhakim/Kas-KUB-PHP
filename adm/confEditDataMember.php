    ...
    if ($tipe_file == "image/jpeg" || $tipe_file == "image/png") {
        ...
        if ($ukuran_file <= 1000000) {
            ...
            if (move_uploaded_file($tmp_file, $path)) {
                ...
                $query = "UPDATE tbl_keanggotaan SET nama='$nama', no_hp='$no_hp', alamat='$alamat', jenis_usaha='$jenis_usaha', nama_usaha='$nama_usaha', foto_member='$nama_file' WHERE id=$id_member";
        ...
        $query = "UPDATE tbl_keanggotaan SET nama='$nama', no_hp='$no_hp', alamat='$alamat', jenis_usaha='$jenis_usaha', nama_usaha='$nama_usaha' WHERE id=$id_member";
        // Eksekusi/ Jalankan query dari variabel $query
        $sql = mysqli_query($db, $query);
